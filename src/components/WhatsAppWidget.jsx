...
const WhatsAppWidget = () => {
  const phoneNumber = "918072702576"; // The phone number from footer
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <button
        ...
        className="bg-[#25D366] hover:bg-[#128C7E] text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 group relative"
