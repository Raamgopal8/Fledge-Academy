...
export default function WixDocking() {
  ...
  const IMAGES = [
    ...
    { src: img7, x: screenW * 0.72, y: 120, w: Math.min(320, screenW * 0.25), h: 240 },
         ...
         {/* Home Page Text Content Codes */}
          ...
          <div className="mt-6 md:mt-10 flex flex-col sm:flex-row items-center justify-center gap-3 w-full px-0">
            <Link to="/courses" className="w-[60%] sm:w-auto">
              <button
                className="w-full bg-[#3B66AC] text-white px-6 py-3 rounded-lg text-base font-medium hover:bg-[#2d4f85] transition"
              >
                Explore Courses
              </button>
            </Link>
